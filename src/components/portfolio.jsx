            ...
            <div className="col-sm-12">
              <div className="title-box text-center">
                ...
                <p className="subtitle-a">
                  These are snapshots of some of the projects I have worked on.
                </p>
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Social Network App</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            Social Network App Using ReactJs and Redux
                          </span>
                        </div>
                      </div>
              ...
              <div className="work-box">
                <a href={stock2} data-lightbox="gallery-aguadeluz">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">To do App</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            This is a to do app developed using React and Redux
                          </span>{" "}
                        </div>
                      </div>
                      <div className="col-sm-4">
              ...
              <div className="work-box">
                <a href={stock3} data-lightbox="gallery-todo">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">DevHub: Social Interactive Platform for Developers</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
